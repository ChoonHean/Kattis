...
inline void solve() {
    int m, n, t;
    cin >> m >> n >> t;
    if (t == 7)cout << (m < n ? "TLE" : "AC");
    else if (t == 6)cout << (log2(n) * n <= m ? "AC" : "TLE");
    else if (t == 5)cout << (sqrt(m) < n ? "TLE" : "AC");
    else if (t == 4)cout << (cbrt(m) < n ? "TLE" : "AC");
    else if (t == 3)cout << (pow(m, 1.0 / 4) < n ? "TLE" : "AC");
    else if (t == 2) {
        if (n > 30)cout << "TLE";
        else cout << ((1 << n) <= m ? "AC" : "TLE");
    } else {
        if (n > 12)cout << "TLE";
        else {
            int a = 1;
